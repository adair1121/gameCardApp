class RebornPanel extends BaseEuiView{
	...
	private onItemTap(evt:eui.ItemTapEvent):void{
		...
		if(item.ifReborn){
			...
			let obj:any = {skillId:this._skillId,rebornId:item.mid,skillIcon:item.icon,skillTitle:`reborn_title_${curRebornCfg.rmodel}_png`,level:skillCfg.level,desc:curRebornCfg.desc,atk:5*skillCfg.level+45,hp:50*skillCfg.level+550,atkDis:100,cost:10*skillCfg.level+90,skillType:1};
