window.skins={};
	...
	function GameMainViewSkin() {
		_super.call(this);
		this.skinParts = ["pos1","pos2","blood","addGoldBtn","addGemBtn","goldLab","gemLab","itemGroup","settingBtn","countNumLab","levelNumLab","progressBar","progressMark","upgradeBtn","list","scroller","boxLab","awardBox","descLab","clickRect","upred","monImg","monGroup","bar","barMask","skillUseGroup"];
		
		this.height = 640;
		this.width = 1136;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.pos1_i(),this.pos2_i(),this._Image3_i(),this.blood_i(),this.itemGroup_i(),this.settingBtn_i(),this._Group1_i(),this._Group2_i(),this.upgradeBtn_i(),this._Image11_i(),this.scroller_i(),this.awardBox_i(),this.descLab_i(),this.clickRect_i(),this.upred_i(),this.monImg_i(),this.monGroup_i(),this.skillUseGroup_i()];
	}
	...
	_proto.itemGroup_i = function () {
		...
		t.x = 8;
		t.y = 4;
		t.elementsContent = [this._Image4_i(),this._Image5_i(),this._Image6_i(),this._Image7_i(),this.addGoldBtn_i(),this.addGemBtn_i(),this.goldLab_i(),this.gemLab_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.touchEnabled = false;
		t.touchThrough = false;
		t.elementsContent = [this._Image8_i(),this.countNumLab_i(),this.levelNumLab_i(),this._Image9_i()];
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.touchEnabled = false;
		t.touchThrough = false;
		t.elementsContent = [this._Image10_i(),this.progressBar_i(),this.progressMark_i()];
		return t;
	};
	...
	_proto.awardBox_i = function () {
		...
		t.touchEnabled = true;
		t.touchThrough = false;
		t.elementsContent = [this._Image12_i(),this.boxLab_i()];
		return t;
	};
	...
	_proto.skillUseGroup_i = function () {
		...
		t.x = 418;
		t.y = 530;
		t.elementsContent = [this._Image13_i(),this.bar_i(),this.barMask_i()];
		return t;
	};
	...
	function BattleResultPopUpSkin() {
		_super.call(this);
		this.skinParts = ["winIcon","resultImg","timeLab","nextBtn","goldNumLab","rewardGroup","continueBtn","exitBtn"];
		
		this.currentState = "win";
		this.height = 768;
		this.width = 1136;
		this.elementsContent = [this._Image1_i(),this.winIcon_i(),this.resultImg_i(),this._Label1_i(),this.timeLab_i(),this.rewardGroup_i()];
		this.nextBtn_i();
		...
		this.states = [
			new eui.State ("win",
				[
					...
					new eui.SetProperty("winIcon","left",63),
					new eui.SetProperty("winIcon","top",96),
					new eui.SetProperty("winIcon","anchorOffsetX",251.52),
					new eui.SetProperty("winIcon","anchorOffsetY",260.61),
					new eui.SetProperty("_Label1","visible",false),
					new eui.SetProperty("timeLab","visible",false),
					new eui.SetProperty("goldNumLab","top",28),
					new eui.SetProperty("goldNumLab","x",118.5),
					new eui.SetProperty("_Label2","left",1),
					new eui.SetProperty("_Label2","top",27),
					new eui.SetProperty("_Image2","left",80),
					...
					new eui.SetProperty("rewardGroup","left",638),
					new eui.SetProperty("rewardGroup","top",306)
				])
			,
			new eui.State ("fail",
				[
					...
					new eui.SetProperty("winIcon","left",15),
					new eui.SetProperty("winIcon","top",96),
					new eui.SetProperty("resultImg","source","fail_font_png"),
					new eui.SetProperty("_Label1","visible",false),
					new eui.SetProperty("timeLab","visible",false),
					new eui.SetProperty("goldNumLab","x",132),
					new eui.SetProperty("goldNumLab","y",16.66),
					new eui.SetProperty("_Label2","x",0),
					new eui.SetProperty("_Label2","y",16.66),
					new eui.SetProperty("_Image2","x",86),
					new eui.SetProperty("_Image2","y",21.66),
					new eui.SetProperty("rewardGroup","anchorOffsetX",0),
					new eui.SetProperty("rewardGroup","width",279.33),
					new eui.SetProperty("rewardGroup","anchorOffsetY",0),
					new eui.SetProperty("rewardGroup","height",60),
					new eui.SetProperty("rewardGroup","left",662),
					new eui.SetProperty("rewardGroup","top",314)
				])
		];
	}
	...
	function ShopPopUpSkin() {
		_super.call(this);
		this.skinParts = ["list","scroller","returnBtn","content"];
	...
	function UpgradePopUpSkin() {
		_super.call(this);
		this.skinParts = ["list","scroller","btnClose","upgradeGroup"];
		
		this.height = 640;
		this.width = 1136;
		this.elementsContent = [this._Rect1_i(),this.upgradeGroup_i()];
	}
	...
	function SettingPopUpSkin() {
		_super.call(this);
		this.skinParts = ["btnClose","musicBar","musicBarMask","effectBar","effectBarMask","m_sound_control","e_sound_control","content"];
	...
	_proto.content_i = function () {
		...
		t.elementsContent = [this._Image1_i(),this.btnClose_i(),this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Image5_i(),this.musicBar_i(),this.musicBarMask_i(),this.effectBar_i(),this.effectBarMask_i(),this.m_sound_control_i(),this.e_sound_control_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
